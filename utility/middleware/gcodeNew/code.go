...
var (
	...
	CodeOK                        = localCode{200, "OK", nil}                          // It is OK.
	CodeInternalError             = localCode{500, "服务器错误", nil}                       // An error occurred internally.
	...
	CodeNotFound                  = localCode{404, "未找到", nil}                         // Resource does not exist.
